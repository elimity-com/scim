...
func TestOperationValidator_ValidateUpdate(t *testing.T) {
	...
	for i, test := range []struct {
		...
		{
			valid:   map[string]any{"op": "add", "path": "attr1", "value": "value"},
			invalid: map[string]any{"op": "add", "path": "attr1"},
		},

		// A URI prefix in the path.
		{
			valid:   map[string]any{"op": "add", "path": "test:PatchEntity:attr1", "value": "value"},
			invalid: map[string]any{"op": "add", "path": "invalid:attr1", "value": "value"},
		},
		{valid: map[string]any{"op": "add", "path": "test:PatchExtension:attr1", "value": "value"}},
		...
		{
			valid:   map[string]any{"op": "add", "path": "complex.attr1", "value": "value"},
			invalid: map[string]any{"op": "add", "path": "complex.attr1", "value": map[string]any{"attr1": "value"}},
		},
		{
			valid:   map[string]any{"op": "add", "path": "complex", "value": map[string]any{"attr1": "value"}},
			invalid: map[string]any{"op": "add", "path": "complex", "value": "value"},
		},
		...
		{
			valid:   map[string]any{"op": "add", "value": map[string]any{"attr1": "value"}},
			invalid: map[string]any{"op": "add", "value": "value"},
		},
		{invalid: map[string]any{"op": "add", "value": map[string]any{"invalid": "value"}}},
		{invalid: map[string]any{"op": "add", "value": map[string]any{"invalid:attr1": "value"}}},

		// If the target location specifies a multi-valued attribute, a new value is added to the attribute.
		{valid: map[string]any{"op": "add", "value": map[string]any{"multiValued": "value"}}},

		// Example on page 36 (RFC7644, Section 3.5.2.1).
		{valid: map[string]any{"op": "add", "path": "complexMultiValued", "value": []any{map[string]any{"attr1": "value"}}}},
		{valid: map[string]any{"op": "add", "path": "complexMultiValued", "value": map[string]any{"attr1": "value"}}},

		// Example on page 37 (RFC7644, Section 3.5.2.1).
		{valid: map[string]any{"op": "add", "value": map[string]any{"attr1": "value", "complexMultiValued": []any{map[string]any{"attr1": "value"}}}}},

		{
			valid:   map[string]any{"op": "add", "path": `complexMultiValued[attr1 eq "value"].attr1`, "value": "value"},
			invalid: map[string]any{"op": "add", "path": `complexMultiValued[attr1 eq "value"].attr2`, "value": "value"},
		},
		{
			valid:   map[string]any{"op": "add", "path": `test:PatchEntity:complexMultiValued[attr1 eq "value"].attr1`, "value": "value"},
			invalid: map[string]any{"op": "add", "path": `test:PatchEntity:complexMultiValued[attr2 eq "value"].attr1`, "value": "value"},
		},

		// Valid path, attribute not found.
		{invalid: map[string]any{"op": "add", "path": "invalid", "value": "value"}},
		{invalid: map[string]any{"op": "add", "path": "complex.invalid", "value": "value"}},

		// Sub-attributes in complex assignments.
		{valid: map[string]any{"op": "add", "value": map[string]any{"complex.attr1": "value"}}},

		// Has no sub-attributes.
		{invalid: map[string]any{"op": "add", "path": "attr1.invalid", "value": "value"}},

		// Invalid types.
		{invalid: map[string]any{"op": "add", "path": "attr1", "value": 1}},
		{invalid: map[string]any{"op": "add", "path": "multiValued", "value": 1}},
		{invalid: map[string]any{"op": "add", "path": "multiValued", "value": []any{1}}},
		{invalid: map[string]any{"op": "add", "path": "complex.attr1", "value": 1}},
		{invalid: map[string]any{"op": "add", "value": map[string]any{"attr1": 1}}},
		{invalid: map[string]any{"op": "add", "value": map[string]any{"multiValued": 1}}},
